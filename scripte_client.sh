...
/usr/bin/mount 10.84.161.166:/vol/Vsavbase/Qsavbase.u/clamav /antivirus/ClamavBase/
echo "10.84.161.166:/vol/Vsavbase/Qsavbase.u/clamav /antivirus/ClamavBase/    nfs     rw      0 0" >> /etc/fstab
...
baseurl=http://mrf-m2i03.valles.ratp/base/
 
[extras]
name=CentOS-\$releasever - centosplus RATP
baseurl=http://mrf-m2i03.valles.ratp/extras/

[updates]
name=CentOS-\$releasever - extras RATP 
baseurl=http://mrf-m2i03.valles.ratp/updates/
 
[centosplus]
name=CentOS-\$releasever\ - updates RATP
baseurl=http://mrf-m2i03.valles.ratp/centosplus/
EOF
fi
